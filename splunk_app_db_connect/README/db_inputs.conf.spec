...
# Determines if a scripted or modular inputs runs on one search head in SHC.
...
# Supported from version 3.10.0.
# It refers to the KV Store document that contains the checkpoint info.
